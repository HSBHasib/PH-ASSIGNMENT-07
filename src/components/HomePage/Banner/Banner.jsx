  ...
  return (
    <div className='space-y-5 w-3/4 mx-auto'>
      ...
      <div className='flex flex-col justify-center items-center text-center space-y-5 pt-14 pb-4'>
        <h1 className='text-[#1F2937] text-3xl md:text-4xl font-bold'>Friends to keep close in your life</h1>
        <p className='text-[#64748B] text-[13px] sm:text-[14px] md:w-[55%] leading-5'>Your personal shelf of meaningful connections. Browse, tend, and nurture the relationships that matter most.</p>
